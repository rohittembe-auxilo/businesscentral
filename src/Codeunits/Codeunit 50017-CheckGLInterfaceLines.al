codeunit 50017 "Check GL Interface Lines1"
{
    // version CCIT AN
    ...
    var
        ...
        Text001: Label 'GenJournalLine Record Already Exits.';
    ...
    var
        ...
        Gen_Ledger_Set: Record "General Ledger Setup";
    begin
        LINENO := 10000;
        PLCLogDetail.RESET;
        ...
        IF PLCLogDetail.FINDFIRST THEN BEGIN
            ...
            */
            ...
            ELSE IF RecGLInterface."Recurring Method" = 'F Fixed' THEN
                RecGJL."Recurring Method" := RecGJL."Recurring Method"::"F  Fixed"
            ELSE IF RecGLInterface."Recurring Method" = 'RB Reversing Balance' THEN
                RecGJL."Recurring Method" := RecGJL."Recurring Method"::"RB Reversing Balance"
            ELSE IF RecGLInterface."Recurring Method" = 'RF Reversing Fixed' THEN
                RecGJL."Recurring Method" := RecGJL."Recurring Method"::"RF Reversing Fixed"
            ELSE IF RecGLInterface."Recurring Method" = 'RV Reversing Variable' THEN
                RecGJL."Recurring Method" := RecGJL."Recurring Method"::"RV Reversing Variable"
            ELSE IF RecGLInterface."Recurring Method" = 'V Variable' THEN
