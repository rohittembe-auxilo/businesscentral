XmlPort 50116 "LMS GL Transaction Import1"
{
    Format = VariableText;
    ...
    schema
    {
        textelement(LMSDATA)
        {
            tableelement("LMS GL Data Stagings"; "LMS GL Data Stagings")
            {
                ...
                begin
                    EntryNo += 1;
                    //"LMS GL Data Stagings"."Posting Date" := TODAY;
                end;
                ...
                begin
                    ...
                    //ERROR('%1',EntryNo);
                    "LMS GL Data Stagings"."Journal Batch Name" := BatchName;
    ...
    begin
        ...
        ELSE
          EntryNo := 1;*/ //CCIT AN Commentted by AN 090123
        ...
        //vmig    BatchName := CheckGLInterfaceLines.GetbatchName;
        if BatchName = '' then
            exit;
    ...
    var
        ...
        //vmig   CheckGLInterfaceLines: Codeunit UnknownCodeunit279;
        BatchName: Text;
}
